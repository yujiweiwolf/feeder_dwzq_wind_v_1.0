...
#define VSS_HKEX_TD_STOCK_CONNECT_MARKET_TURNOVER_SH  226
#define VSS_HKEX_TD_STOCK_CONNECT_DAILY_QUOTE_BANLANCE_SH 227
#define VSS_HKEX_TD_STOCK_CONNECT_MARKET_TURNOVER_SZ  228
#define VSS_HKEX_TD_STOCK_CONNECT_DAILY_QUOTE_BANLANCE_SZ 229
