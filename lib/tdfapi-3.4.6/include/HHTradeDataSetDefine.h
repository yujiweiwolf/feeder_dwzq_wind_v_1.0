...
#define ID_BT_FUND_ETF_IOPV		0x28	//ETF IOPV
#define ID_BT_FUND_REITS		0x29	//REITs
...
#define ID_BT_BOND_BBQ          0x39    //BBQ Bond
...
#define ID_BTEX_CDR				0x01000000  //CDR
#define ID_BTEX_GDR				0x10000000  //GDR
#define ID_BTEX_SHARESAFTER		0x20000000  //处理股票盘后数据(有盘后交易的创业板上线后需使用)
#define ID_BTEX_NEGABDATA		0x00800000  //支持负数盘口数据(nType加上此标志时)
